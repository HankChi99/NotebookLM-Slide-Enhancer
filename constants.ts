export const APP_TITLE = "NotebookLM Slide Enhancer";
export const APP_DESCRIPTION = "Transform PDF exports into high-fidelity slides using the Gemini Nano Banana Pro model.";

// The strict prompt definition provided by the user
export const ENHANCEMENT_PROMPT = `# Role Definition
...
You will receive:
1. An image of a slide (often low resolution or containing artifacts).
2. (Optional) "Reference Context": Text data from the source material (e.g., NotebookLM notes, transcripts).
...
- **CRITICAL**: 若提供了「Reference Context」，必須強制將圖像上的模糊文字與 Context 內容進行交叉比對。
  - 例如：若圖像是 "Ambi... Res...", 但 Context 中有 "Ambiguity Resolution"，請直接修正為完整詞彙。
  - 專有名詞、人名、數據必須與 Context 一致。
